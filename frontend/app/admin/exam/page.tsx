  ...
  if (isLoading || !user) {
    return (
      <div className="flex h-96 items-center justify-center">
        <div className="text-center text-slate-500">Loading Exam Center...</div>
      </div>
    );
  }
        ...
        <div className="mt-8">
          {loading ? (
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-12 text-center shadow-sm">
              ...
              <p className="mt-2 text-sm text-slate-500">Get started by creating a new examination.</p>
              {["admin", "proctor"].includes(user.role) && (
                <div className="mt-6">
                  <Link
                    href="/admin/exam/builder"
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
              {exams.map((exam) => (
                <div key={exam.id} className="flex flex-col rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                  <div className="p-6 flex-1">
                    ...
                    <h3 className="text-lg font-bold text-slate-900 line-clamp-1 mb-2" title={exam.title}>
                      {exam.title}
                    </h3>
